...
public class ErrorHandler {
    ...
    ResponseEntity<ApiError> handleAuthenticatonException(com.example.demo.auth.exception.AuthenticationException authenticationException, HttpServletRequest request) {
        ApiError apiError = new ApiError();
        apiError.setPath(request.getRequestURI());
